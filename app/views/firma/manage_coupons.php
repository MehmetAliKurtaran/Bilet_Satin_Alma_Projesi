<h3><i class="bi bi-ticket-perc"></i> Firma Kupon Yönetimi (Firma Admin)</h3>
<p>Burada oluşturulan kuponlar sadece sizin firmanızın seferlerinde geçerlidir.</p>
<hr>
<div class="row">
    <div class="col-md-4">
        <div class="card shadow-sm">
            <div class="card-header">Yeni Firma Kuponu Ekle</div>
            <div class="card-body">
                <form action="<?php echo BASE_URL; ?>firma/coupons" method="POST">
    ...
    <div class="col-md-8">
         <div class="card shadow-sm">
             <div class="card-header">Mevcut Firma Kuponları</div>
             <div class="card-body">
                <div class="list-group">
                    <?php if (empty($coupons)): ?>
                        <p class="text-muted">Firmaya özel kupon yok.</p>
                    <?php else: ?>
                        <?php foreach ($coupons as $coupon): ?>
                            <div class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <a href="<?php echo BASE_URL . 'firma/coupons?action=delete&id=' . $coupon['id']; ?>" 
